...
**🅱️ Roll B: Kadunud kliendid (Põhiülesanne)**
* 🛠️ [SQL skript](week3_roll_b_kadunud_kliendid.sql) | 📄 [Raport](week3_roll_b_kadunud_kliendid%20Raport.sql) | 📊 [CSV andmed](Supabase%20Snippet%20Untitled%20query%20screenshot%201%20koguandmed.csv) | 🖼️ Tulemused: [1](week3_roll_b_kadunud_kliendid%20screenshot%201.png), [2](week3_roll_b_kadunud_kliendid%20screenshot%202.png), [3](week3_roll_b_kadunud_kliendid%20screenshot%203.png)

**©️ Roll C: Inventuur ja tooted (Lisaroll)**
* 🛠️ [SQL skript](week3_roll_c_muumata_tooted_ja_inventuur.sql) | 📄 [Raport](week3_roll_c_muumata_tooted_ja_inventuur%20RAPORT.sql)

**↩️ Roll D: Müügikanalid (Lisaroll)**
