...
--------------------------------------------------------------------------------
2. PEAMISED TÄHELEPANEKUD MÜÜGI JAOTUMISEL
--------------------------------------------------------------------------------

[TÄHELEPANEK A] Müügikogus vs Rahaline käive
  * Kõige populaarsem toode tükkide arvestuses on "Moodne seemisnahkne oxfordid" 
    (83 tk) jalanõude kategoorias. 
  * Suurima rahalise käibe tõi aga hoopis sama kategooria teisele kohale jäänud 
    "Õhuline sünteetiline kõrge kontsaga kingad" (23 045.88 €), kuna selle toote 
    jaehind on oluliselt kõrgem (291.72 €).

[TÄHELEPANEK B] Hinnaklasside mõju tulemustele
  * Laste ja naiste riiete TOP tooted müüvad küll stabiilselt suurtes kogustes 
    (72-81 tk), kuid nende madalama jaehinna tõttu jääb kogukäive tagasihoidlikuks. 
  * Näiteks laste luksuslikku softshell komplekti müüdi tervelt 80 tükki, kuid 
    see genereeris käivet vaid 2 129.60 €. 
  * Jalanõude ja meeste riiete kategooriates on tooted kallimad, mistõttu toovad 
    sarnased müügikogused sisse kordades suuremaid summasid.

[TÄHELEPANEK C] Tihe konkurents ja viigid
  * Andmetest joonistub välja väga ühtlane ja tihe konkurents. Meeste riiete ja 
    aksessuaaride kategooriates on mitu toodet täpselt sama müügikogusega.
  * Meeste riietes jagavad kaks toodet 1. kohta (73 tk) ja kaks toodet 3. kohta (70 tk).
  * See näitab, et antud kategooriates puudub üks ja selge "hitt-toode" ning 
    kliendid jagunevad erinevate toodete vahel väga võrdselt.
================================================================================



================================================================================
ÄRIANALÜÜSI LÜHIKOKKUVÕTE JA STRATEEGILISED SOOVITUSED
================================================================================

[KASUMLIKUMAD KATEGOORIAD]
Kõige tulusamad kategooriad on jalanõud ja meeste riided, kus kõrged jaehinnad 
tagavad sarnaste müügikoguste juures märkimisväärselt suurema rahalise käibe.

[TÄHELEPANU VAJAVAD TOOTED]
Tähelepanu vajavad laste riided ja naiste osakonna üksikud hitid (nt siidsed 
cargo püksid), mis hoolimata suurest müügimahust toovad liiga madala jaehinna 
tõttu ettevõttele sisse väga väikese kogukäibe.

[STRATEEGILISED SOOVITUSED]
1. Optimeeri hinnastamist: Tõsta populaarsete, kuid odavate mahttoodete hinda 
   või müü neid pakatidena (bundle) koos kõrgema marginaaliga aksessuaaridega.
2. Suuna turundusfookust: Skaleeri edu ja suuna reklaamieelarve jalanõude ning 
   meeste riiete kategooriatele, et võimendada juba praegu kõige enam tulu 
   toovaid "staartooteid".
================================================================================