...
* Leidsin: 
  ...
  * Tabeli on 12 rida id, sale id, invoice id, sale date, customer id, product id, quantity, unit price, total price, channel, store location ja payment method.
...
* Üllatav minu jaoks oligi, et puuduvates andmetes oli 380 emaili puudu, mis tundub tavapärane info minu jaoks kliendi andmebaasides, kui ei usu et nimel kõigil olemas oli, seda tahaks edasi uurida ning samuti tuleb leida linnade valikul ainult sellisel viisid, et võtad dubleeritud linnad välja ja liidad ühte.

---

## 📂 Failid
* 🛠️ `week1_sales_exploration.sql` -- minu sales SQL päringud
* 🛠️ `week1_customers_exploration.sql` -- minu customers SQL päringud
